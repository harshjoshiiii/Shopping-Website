...
//YHA HM 2 CHEEJE DIKAHYNGE --> KYA KYA CHEEJ HAI CART AND THE PRICE 
//YE SB SLICE M PDHA HAI BHA SE LAKR YE DIKHA DIYA.
const Cart = () => {
  ...
  return (
    <div className="mb-10">
        {/* AGR CARD KI LENGTH NON EMPTY HAI TO SARI CART ITEM YHA LIST KRDO */}
      {cart.length > 0 ? (
