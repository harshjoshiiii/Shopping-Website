...
import { remove } from '../redux/Slices/CartSlice'; // Correct import for remove action
  ...
  return (
    <div className="flex items-center p-5 justify-between mt-2 mb-2 mx-5 border-b-[3px] border-slate-500">
      <div className="flex flex-row p-3 gap-5 items-center">
        <div className="w-[30%]">
          <img src={item.image} className="object-cover" alt={item.title} /> {/* Added alt attribute */}
        </div>
